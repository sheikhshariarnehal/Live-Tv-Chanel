...
function parseRSS(xmlText: string, sourceName: string, filterSports = false): Article[] {
...
let newsCache: Article[] | null = null;
let newsCacheExpiresAt = 0;
const NEWS_CACHE_TTL = 10 * 60 * 1000; // Cache news for 10 minutes

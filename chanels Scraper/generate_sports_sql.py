...
def main():
    print("Loading cricfy_channels.json...")
    with open('cricfy_channels.json', 'r', encoding='utf-8') as f:
    ...
    for idx, ch in enumerate(filtered_channels):
        ...
        # Hardcode category to 'sports' as requested
        cat_val = "'sports'"
    ...
    with open('insert_cricfy_sports.sql', 'w', encoding='utf-8') as f:
        f.write("\n".join(sql_lines))
        
    print(f"Generated insert_cricfy_sports.sql with {len(filtered_channels)} rows.")
